...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/AcceptCardSDK/AcceptCardSDK/Classes/AcceptSDK.xcframework" "" "true" "ios-arm64_armv7/AcceptSDK.framework" "ios-i386_x86_64-simulator/AcceptSDK.framework"
fi
